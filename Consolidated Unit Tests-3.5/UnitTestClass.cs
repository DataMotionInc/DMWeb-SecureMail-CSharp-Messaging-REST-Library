...
namespace Messaging_Library.TestFixtures.UnitTestClass
{
    ...
    public class AccountTests
    {
        ...
        public void MoveMessagNoSessionKeyTest()
        {
            ...
            try
            {
                Context.dmWeb.Message.Move(new MessagingModels.MessageOperations { MessageId = MID, DestinationFolderId = DFID });
            }
            catch (WebException ex)
            {
                Assert.IsTrue(ex.Message.Contains("401"));
        ...
        public void MoveMessageMIDOnlyTest()
        {
            ...
            try
            {
                Context.dmWeb.Message.Move(new MessagingModels.MessageOperations { MessageId = MID });
            }
            catch (WebException ex)
            {
                Assert.IsTrue(ex.Message.Contains("401"));
        ...
        public void MoveMessageFIDOnlyTest()
        {
            ...
            try
            {
                Context.dmWeb.Message.Move(new MessagingModels.MessageOperations { DestinationFolderId = DFID });
            }
            catch (WebException ex)
            {
        ...
        public void MoveMessageTrueMIDFalseFIDTest()
        {
            ...
            try
            {
                Context.dmWeb.Message.Move(new MessagingModels.MessageOperations { MessageId = MID, DestinationFolderId = 15143 });
            }
            catch (WebException ex)
            {
                Assert.IsTrue(ex.Message.Contains("401"));
